    ...
    boost::system::error_code& ec)
{
  ...
  if (true)//FARPROC cancel_io_ex_ptr = ::GetProcAddress(::LoadPackagedLibrary(L"KERNEL32.dll"), "CancelIoEx"
  {
    // The version of Windows supports cancellation from any thread.
    typedef BOOL (WINAPI* cancel_io_ex_t)(HANDLE, LPOVERLAPPED);
    cancel_io_ex_t cancel_io_ex = (cancel_io_ex_t)::CancelIoEx;//cancel_io_ex_ptr;
