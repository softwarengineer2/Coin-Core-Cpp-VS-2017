...
//BOOST_SYMBOL_IMPORT void 
//GetModuleHandleEx(boost::detail::winapi::DWORD_ flags, boost::detail::winapi::LPCSTR_ lpFileName, boost::detail::winapi::HMODULE_ WINAPI);
...
/*BOOST_FORCEINLINE void get_module_handle(DWORD_ flags, LPCSTR_ lpFileName, HMODULE_ *module)
{
    //return ::GetModuleHandleA(lpFileName);
    return ::GetModuleHandleEx(flags, lpFileName, module);
}*/
